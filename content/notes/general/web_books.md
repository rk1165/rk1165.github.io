...
1. [Computer Science from the bottom up](https://www.bottomupcs.com/)
2. [Learn Quantum Computation](https://quantum.country/)
3. [Learn Quantum Computation using Qiskit](https://qiskit.org/textbook/preface.html)
4. [Putting the You in CPU](https://cpu.land/)
5. [Foundations of Computer Science](http://infolab.stanford.edu/~ullman/focs.html)
