...
01. [How FoundationDB works and why it works](https://blog.the-pans.com/notes-on-the-foundationdb-paper/)
02. [Faster ClickHouse Imports](https://tech.marksblogg.com/faster-clickhouse-imports-csv-parquet-mysql.html)
03. [Database Fundamentals](https://tontinton.com/posts/database-fundementals/)
04. [Understanding Database Replication: A Practical Overview](https://medium.com/@atakanserbes/understanding-database-replication-a-practical-overview-dbe23344acc7)
05. [How we Built a 19 PiB Logging Platform with ClickHouse and Saved Millions](https://clickhouse.com/blog/building-a-logging-platform-with-clickhouse-and-saving-millions-over-datadog)
...
16. [Relational Databases Explained](https://architecturenotes.co/things-you-should-know-about-databases/)
17. [Herding elephants: Lessons learned from sharding Postgres at Notion](https://www.notion.so/blog/sharding-postgres-at-notion)
18. [Amazon Aurora: Design Considerations + On Avoiding Distributed Consensus for I/Os, Commits, and Membership Changes](https://muratbuffalo.blogspot.com/2022/03/amazon-aurora-design-considerations-and.html?m=1)
19. [Things I Wished More Developers Knew About Databases](https://rakyll.medium.com/things-i-wished-more-developers-knew-about-databases-2d0178464f78)
20. [42 things I learned from building a production database](https://maheshba.bitbucket.io/blog/2021/10/19/42Things.html)
...
3. [A Comprehensive Guide to Cassandra Architecture](https://www.instaclustr.com/cassandra-architecture/)
4. [Cassandra Data Partitioning](https://www.instaclustr.com/cassandra-data-partitioning/)

### PostgreSQL

1. [How Postgres Chooses Which Index To Use For A Query](https://pganalyze.com/blog/how-postgres-chooses-index)
2. [Postgres Indexes for Newbies](https://blog.crunchydata.com/blog/postgres-indexes-for-newbies)
...
2. [MySQL Sharding at Quora](https://quoraengineering.quora.com/MySQL-sharding-at-Quora)
