...
1. [CACHE COLLISION - Memcached vs Redis](https://engineering.kablamo.com.au/posts/2021/memcached-vs-redis-whats-the-difference)
2. [How browsers work](https://web.dev/howbrowserswork/)
3. [CSS Utility Classes and "Separation of Concerns"](https://adamwathan.me/css-utility-classes-and-separation-of-concerns/)
4. [How video works](https://howvideo.works/)
5. [RTC (Real-Time Communication) at scale](http://www.horatiulazu.ca/blog/coop/2020/05/02/rt-calling.html)
...
1. [fb-Infer](https://fbinfer.com/docs/infer-workflow/)
2. [TailWind CSS](https://tailwindcss.com/)
3. [jsonschema2pojo](https://www.jsonschema2pojo.org/)
4. [Online regex tester and debugger](https://regex101.com)
5. [ngrok - secure introspectable tunnels to localhost](https://dashboard.ngrok.com/login)
6. [SocketXP](https://portal.socketxp.com/#/login)
7. [Login - PortSwigger](https://portswigger.net/users)
8. [HexEd.it - Browser-based Online and Offline Hex Editing](https://hexed.it)
9. [CloudAMQP - RabbitMQ in the cloud](https://customer.cloudamqp.com/login)
