...
- [Summary of reading: October - December 2022](https://eli.thegreenplace.net/2022/summary-of-reading-october-december-2022/)
...
- [Summary of reading: July - September 2022](https://eli.thegreenplace.net/2022/summary-of-reading-july-september-2022/)
...
- [Processing XML in Python with ElementTree](https://eli.thegreenplace.net/2012/03/15/processing-xml-in-python-with-elementtree)
...
- [From C to AST and back to C with pycparser](https://eli.thegreenplace.net/2011/03/07/from-c-to-ast-and-back-to-c-with-pycparser)
...
- [Equivalence classes and group partitions](https://eli.thegreenplace.net/2009/07/17/equivalence-classes-and-group-partitions)
...
- [Programming language typing - a big mishmash](https://eli.thegreenplace.net/2006/12/02/programming-language-typing-a-big-mishmash)
- [A taxonomy of typing systems](https://eli.thegreenplace.net/2006/11/25/a-taxonomy-of-typing-systems)
- [Understanding Ruby blocks, Procs and methods](https://eli.thegreenplace.net/2006/04/18/understanding-ruby-blocks-procs-and-methods)
- [Ruby as both a functional and an OO language](https://eli.thegreenplace.net/2006/03/25/ruby-as-both-a-functional-and-an-oo-language)
...
- [lambdaÂ²](https://eli.thegreenplace.net/2004/07/30/lambda2)
- [making sense of pointers](https://eli.thegreenplace.net/2004/05/14/making-sense-of-pointers)
- [The Jotto word game - analysis and a Perl implementation](https://eli.thegreenplace.net/2004/01/19/the-jotto-word-game-analysis-and-a-perl-implementation)
...
- [perl bit-crunching](https://eli.thegreenplace.net/2003/10/20/perl-bit-crunching)
...
- [some Perl "magic"](https://eli.thegreenplace.net/2003/07/18/some-perl-magic)
- [test vectors generation in Perl](https://eli.thegreenplace.net/2003/07/17/test-vectors-generation-in-perl)
- [Some benchmarking in Perl](https://eli.thegreenplace.net/2003/07/10/some-benchmarking-in-perl)
...
- [Perlmix progress](https://eli.thegreenplace.net/2003/06/02/perlmix-progress)
- [Perlines](https://eli.thegreenplace.net/2003/05/30/perlines)
- [some pondering on design of MIX in Perl](https://eli.thegreenplace.net/2003/05/20/some-pondering-on-design-of-mix-in-perl)
- [Using perl for hardware verification](https://eli.thegreenplace.net/2003/05/16/using-perl-for-hardware-verification)
...
- [Automatically testing changes in state! Visualizing my Git workflow! Floats!](https://jvns.ca/blog/2013/11/13/day-27-magic-testing-functions/) **trying to TCP**
...
- [I conquered thread pools! For today, at least.](https://jvns.ca/blog/2016/03/29/thread-pools-part-ii-i-love-blocking/)
...
- [Debugging netlink requests](https://jvns.ca/blog/2017/09/03/debugging-netlink-requests/) **networking**
