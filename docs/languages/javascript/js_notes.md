...
- `docker run --name pg -p 5432:5432 -v /home/ravi/data/pg:/var/lib/postgresql/data postgres`
- we create a new folder pgbrandnew with pg contents
- `docker run --name pg -p 1234:5432 -v /home/ravi/data/pgbrandnew:/var/lib/postgresql/data postgres`
