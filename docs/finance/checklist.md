...
- The consensus view is that in 1/3/5/10 years this company/industry will be at X. If you think the answer is different than X, the further away it is from X the better the investment opportunity
  will be.
...
- Never lost sight of the facts that investing is both probabilistic and mean reverting
- **Fundamental attribution errors** When we succeed, we're likely to conclude that our talents and our current model or strategy are the reasons.
