...
- We can use `ENTRYPOINT` to define the main exexcutable and then docker will combine our run arguments for it.
...
- A volume is simple a folder (or a file) that is shared between the host machine and the container.
