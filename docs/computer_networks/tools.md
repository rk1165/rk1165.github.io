...
- World Whois Databases - Regional Intenet Registeries
- APNIC (Asia Pacific), AFRINIC (Africa), RIPE NCC (Europe, Central Asia, Middle East), ARIN (Northern America), Lacnic (LatAm)
...
- whois xyz.com
- There are a lot of other options to tinker with. check man page.
...
- scp mailout.jar c5017417@server_name:/tmp
