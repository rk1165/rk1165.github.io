...
- [DB Sharding](https://www.digitalocean.com/community/tutorials/understanding-database-sharding) ***
- [What is a query planner?](https://planetscale.com/blog/what-is-a-query-planner) ***
- [Noria](https://www.micahlerner.com/2021/03/28/noria-dynamic.html) *
- [MemTable, WAL, SSTable, Log Structure Merge(LSM) Trees](https://ninegene.com/2022/02/21/memtable-wal-sstable-log-structured-mergelsm-trees/) ***
...
- [MySQL Sharding at Quora](https://quoraengineering.quora.com/MySQL-sharding-at-Quora) ***
- [Relational Databases Explained](https://architecturenotes.co/things-you-should-know-about-databases/) **
- [Herding elephants: Lessons learned from sharding Postgres at Notion](https://www.notion.so/blog/sharding-postgres-at-notion) **
- [Amazon Aurora: Design Considerations + On Avoiding Distributed Consensus for I/Os, Commits, and Membership Changes](https://muratbuffalo.blogspot.com/2022/03/amazon-aurora-design-considerations-and.html?m=1) **
...
- [How Python Async works](https://guicommits.com/how-python-async-works/) ***
- [Python Concurrency from the ground up](https://www.youtube.com/watch?v=MCs5OvhV9S4&ab_channel=PyCon2015) ***
- [Python Concurrency: The Tricky bits](https://python.hamel.dev/concurrency/) ***
- [A BitTorrent Client written in Python](https://markuseliasson.se/article/bittorrent-in-python/) **
...
- [Cool CLIs in Elixir with IO.write/2](https://dennisbeatty.com/cool-clis-in-elixir-with-io-write-2/) ***
- [Cool CLIs in Elixir with IO.ANSI](https://dennisbeatty.com/cool-clis-in-elixir-part-2-with-io-ansi/) ***
- [Architecting GenServers for Testability](https://www.youtube.com/watch?v=EZFLPG7V7RM&ab_channel=ElixirConf) **
- [A Practical Guide to Elixir Protocols](https://www.youtube.com/watch?v=sJvfCE6PFxY&ab_channel=ErlangSolutions) **
- [Build a JSON API with Phoenix](https://lobotuerto.com/notes/build-a-json-api-with-phoenix) ***
- [Access Module](https://erikarow.land/articles/favorite-elixir-discovery) ***
- [Learn with Me: Elixir](https://inquisitivedeveloper.com/tag/lwm-elixir/) ***
- [Elixir School](https://elixirschool.com/en) ***
- [Elixir Tutorial](https://elixir-lang.org/getting-started/introduction.html) ***
- [Intro to OTP in Elixir](https://www.youtube.com/watch?v=CJT8wPnmjTM&ab_channel=FullStackTalks)
- [10 tips for new Elixir developers](https://www.chriis.dev/opinion/10-tips-for-new-elixir-developers) ***
- [Pearls of Elixir - Interesting patterns](https://minhajuddin.com/2019/02/01/pearls-of-elixir-interesting-patterns-from-popular-elixir-packages/) ***
...
- [How I Hacked 40 Websites in 7 minutes – Hacker Noon](https://hackernoon.com/how-i-hacked-40-websites-in-7-minutes-5b4c28bc8824) *
...
- [How to survive an InfoSec job interview (cryptography)](https://www.coengoedegebure.com/surviving-an-infosec-job-interview-cryptography/) *
...
- [C/Debugging](http://www.cs.yale.edu/homes/aspnes/pinewiki/C(2f)Debugging.html) **
...
- [Notes on DS and Programming Techniques](http://www.cs.yale.edu/homes/aspnes/classes/223/notes.html) *