...
- [Quicksort using Dutch National Flag Algorithm](http://www.techiedelight.com/quicksort-using-dutch-national-flag-algorithm/)
- [Quick Sort using Hoare’s Partitioning scheme](http://www.techiedelight.com/quick-sort-using-hoares-partitioning-scheme/)
...
- [Find two duplicate elements in an limited range array (using XOR)](http://www.techiedelight.com/find-two-duplicate-elements-limited-range-array-using-xor/)
- [Find missing number and duplicate elements in an array](http://www.techiedelight.com/find-missing-number-duplicate-elements-array/)
...
- [Reverse Bits of an integer using lookup table](http://www.techiedelight.com/reverse-bits-integer-using-lookup-table/)
...
- [Counting Sort Algorithm](http://www.techiedelight.com/counting-sort-algorithm-implementation/)
...
- [Remove adjacent duplicate characters from a string](http://www.techiedelight.com/remove-adjacent-duplicates-characters-string/)
