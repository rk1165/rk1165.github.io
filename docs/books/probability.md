...
- _**Recognition heuristic**_: If you recognize the name of one city but not that of the other, then you infer that the recognized city has the larger population.
...
- _**Defensive decision making**_: A person or group ranks option A as the best for the situation, but chooses an inferior option B to protect itself in case something goes wrong.
- No X-Rays for children.
- Questions to ask:
...
- Hire well and let them do their jobs. (needed for cutting-edge innovation)
...
- Ask the waiter: What would you eat here this evening? (In good restaurants)
- Imitate your peers while ordering.
...
- The major difference between a thing that might go wrong is that when a thing that cannot possibly go wrong goes wrong it usually turns out to be impossible to get at or repair.
...
- Foxes are considerable better at forecasting than hedgehogs.
...
| **Cautious:** Express their predictions in probabilistic terms and qualify their opinions.                                                                     | **Confident:** Rarely hedge their predictions and are reluctant to change them.**Empirical:** Rely more on observation than theory.                           | **Ideological:** Expect that solutions to many day-to-day problems are manifestations of some grander theory or struggle. |
...
- Calibration punish overconfidence - a trait that most forecasters have in spades.
...
- Extrapolation is a very basic method of prediction - usually, much too basic. It simply involves the assumption that the current trend will continue indefinitely, into the future.
- One of the most useful quantities for predicting disease spread is a variable called the basic reproduction number. Usually designated as R*0, \_it measures the number of uninfected people that can expect to catch a disease from a single infected individual*. An R_0 of 4, for instance, means that — in the absence of vaccines or other preventative measures - someone who gets a disease can be expected to pass it along to four other individuals before recovering (or dying) from it.
...
- We have to view technology as what it always has been—a tool for the betterment of the human condition. We should neither worship at the altar of technology nor be frightened by it.
- A flush has about a 1-in-3 chance of coming in with two cards to come, or that a pair of aces will beat a pair of kings about 80 percent of the time.
...
- It implies that although you might occasionally be able to beat markets, it is not something you should count on doing every day; that is a sure sign of overconfidence.
...
- Mithridatization the result of an exposure to a small dose of a substance that, over time, makes one ummune to additional, larger quantities of it.
- _Hormesis_ a word conined by pharmacologists, is when a small dose of a harmful substance is actually beneficial for the organism, acting as medicine.
...
- The more variability you observer in a system, the lest Black Swan prone it is.
...
- When you become rich, the pain of losing your forune exceeds the emotional gain of getting addtional wealth, so you start living under continuous emotional threat.
...
- You can easily switch apartments and reduce your monthly payments - or even buy a new apartment and get a mortgage with lower monthly payments.
...
- The treasure, what one needs to know for a profession, is necessarily what lies outside the corpus, as far away from the center as possible.
...
- I am invariably hit with the following idea. If true wealth consists in worriless sleeping, clear conscience, reciprocal gratitude, absence of envy, good appetit, muscle strength, physical energy, frequent laughs, no meals alone, no gym class, some physical labor (or hobby), good bowel movements, no meeting rooms, and periodic surprises, then it is largely subtractive.
...
- George Sors, when making a financial bet, keeps looking for instances that would prove his initial theory wrong. This, perhaps, is true self-confidence: the ability to look at the world without the need to find signs that stroke one's ego.
...
- There are two varities of rare events:
  - a) the _narrated_ Black Swans, those that are present in the current discourse and that you are likely to hear about on TV.
  - b) those nobody talks about, since they escape models - those that you would feel ashamed discussing in public because they do not seem plausible.
