...
- So that is really the first piece of advice I’ll give; don’t take losing a job or having to move jobs too personally, because it’s almost certain to happen at some point.
...
1. Write your resume. List all your relevant skills, then note the ones that will still be needed in 100 years. Give yourself a 1-10 rating in each skill. math, computer science, writing, and people skills are for the most part timeless, universal skills. Most specific technologies, languages and protocols eventually expire, to be replaced by better alternatives.
...
- Twitted did precisely this with their [Finagle RPC system](https://twitter.github.io/finagle/). Functionality like request metrics, traffic splitting, retries, and more was coded once and then shared across every service at Twitter.
